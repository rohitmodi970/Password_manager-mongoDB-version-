...
//connecting with mongoDB
    ...
    const editPass = (id) => {
        ...
        setForm({...passwordArray.filter(item => item.id === id)[0], id:id});//set the id jis id ko edit kar na chahata hu step1
        //Method:1
        // deletePass(id)
        //Method:2
        setPasswordArray(passwordArray.filter(item => item.id !== id));
                    ...
                    <div className="flex flex-col md:flex-row w-full gap-8">
                        ...
                        <div className="relative">
                            ...
                            <span className='absolute right-[3px] top-[4px] cursor-pointer' onClick={showPass}>
                                <img ref={ref} className='p-1' width={25} src="/icons/eye.png" alt="toggle visibility" />
                            </span>
                        </div>
                    </div>
                                ...
                                {passwordArray.map((item, index) => (
                                    <tr key={index}>
                                        ...
                                        <td className='text-center py-3 border border-white '>
                                            <div className="flex justify-center items-center">
                                                <span>
                                                    {/* this will show thw password as text  */}
                                                    {/* {item.password.length} */}
                                                    {/* this will show the passwords as '*' */}
